...
if __name__ == '__main__':
    ...
    for i, data in enumerate(dataset):
        ...
        cycle_loss = current_losses['cycle_B']
    ...
    # Calculate and print average cycle consistency loss
    if num_images > 0:
    ...
    with open(os.path.join(web_dir, 'losses.json'), 'w') as f:
