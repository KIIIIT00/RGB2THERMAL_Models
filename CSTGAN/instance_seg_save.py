...
def process_images_in_folder(folder_paths, model, mask_color_dict, output_dir):
    ...
    for original_path in original_images:
        ...
        gen_thermal_path = os.path.join(gen_thermal_folder, f"rgb_{idx}_fake.jpg")
...
FOLDER_PATHS = (
    ...
    f"./CycleGAN/results/{pretrained_model_name}/{pretrained_model_name}/test_latest/images"
)

OUTPUT_DIR = f'./instance_seg/{pretrained_model_name}/'
